...
/******/ 	var hotCurrentHash = "dd499970e6bc6b8052ca"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _times = __webpack_require__(36);
	...
	var CalendarContainerComponent = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            this._rows(),
	            _react2.default.createElement(_events2.default, { events: this.props.events })
	        );
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _event2 = __webpack_require__(39);
	            ...
	            if (this.props.events.hasOwnProperty(key)) {
	                (function () {
	                    ...
	                    _eventsComponents = _eventsComponents.concat(_events.map(function (_event) {
	                        ...
	                        var _component = _react2.default.createElement(_event3.default, { event: _event, key: _key, overlap: _events.length, position: _position, title: _event.title, location: _event.location });
	                        _position++;
	                        return _component;
	                    }));
	                })();
